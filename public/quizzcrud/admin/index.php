...
<body class="bg-gray-100 text-gray-900 min-h-screen flex flex-col">
    ...
    <div class="max-w-5xl mx-auto p-4 md:p-8 w-full">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="/quizzcrud/admin/edit-quiz.php" class="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition">
                Créer un quiz
            </a>
        </div>
                    ...
                    if (empty($quiz_files)) {
                        ...
                        foreach ($quiz_files as $file) {
                            ...
                            <tr class="border-b">
                                ...
                                <td class="p-2">
                                    <a href="/quizzcrud/admin//edit-quiz.php?quiz_id={$quiz_id}" class="text-indigo-600 hover:underline">Modifier</a>
                                    <a href="/quizzcrud/admin/{$action_link}" class="text-blue-600 hover:underline ml-4">{$action_text}</a>
                                    <a href="/quizzcrud/admin/delete-quiz.php?quiz_id={$quiz_id}" class="text-red-600 hover:underline ml-4" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce quiz ?');">Supprimer</a>
                                </td>
                            </tr>
HTML;
                        }
