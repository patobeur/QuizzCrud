        ...
        <section class="bg-white rounded-2xl shadow p-5 md:p-6">
            <table class="w-full text-left">
                ...
                <tbody>
                    <?php if (empty($users)): ?>
                        <tr>
                            <td colspan="3" class="p-2 text-center">Aucun utilisateur trouvé.</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($users as $user): ?>
                            <tr class="border-b">
                                ...
                                <td class="p-2">
                                    <a href="/quizzcrud/admin/edit-user.php?user_id=<?php echo $user['id']; ?>" class="text-indigo-600 hover:underline">Modifier</a>
                                    <a href="/quizzcrud/admin/delete-user.php?user_id=<?php echo $user['id']; ?>" class="text-red-600 hover:underline ml-4" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?');">Supprimer</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
