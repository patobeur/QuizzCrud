...
<div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[260px,1fr] gap-6 px-4 py-6">
    ...
    <aside class="lg:block bg-white/70 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 h-max sticky top-20 hidden" id="toc">
      ...
      <div class="mt-4 flex flex-col gap-2">
        <a href="/tutoriels/downloads/index equiv exercices.xlsx" class="px-3 py-2 text-center rounded-md border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-sm">Télécharger exercices (Excel)</a>
        <a href="/tutoriels/downloads/index equiv correction.xlsx" class="px-3 py-2 text-center rounded-md border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-sm">Télécharger correction (Excel)</a>
      </div>
    </aside>
    ...
    <main id="content" class="space-y-8">
      ...
      <section id="tab-index" class="tab-panel space-y-6" data-anchor-title="Feuille INDEX">
        ...
        <article class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm fade-in" id="index-prereq">
          <button class="acc-btn w-full text-left"><h3 class="text-lg font-bold flex items-center justify-between">2) Ce qu’il faut comprendre avant de taper la moindre formule <span class="chev text-slate-400">▾</span></h3></button>
        ...
        <article class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm fade-in" id="index-formula">
          <button class="acc-btn w-full text-left"><h3 class="text-lg font-bold flex items-center justify-between">3) La formule, expliquée <span class="chev text-slate-400">▾</span></h3></button>
      ...
      <section id="tab-index-equiv" class="tab-panel hidden space-y-6" data-anchor-title="Feuille INDEX+EQUIV">
        ...
        <article class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm fade-in" id="combo-combos">
          <button class="acc-btn w-full text-left"><h3 class="text-lg font-bold flex items-center justify-between">3) Les combinaisons, expliquées simplement <span class="chev text-slate-400">▾</span></h3></button>
          <div class="acc-panel mt-3 space-y-3">
            <div>
