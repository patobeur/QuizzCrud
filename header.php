    ...
    <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div id="nav-links" class="hidden lg:flex items-center space-x-6">
            ...
            <div class="relative group">
                <button class="text-gray-700 hover:text-indigo-600 transition flex items-center">
                    <span>Tests</span>
        ...
        <div class="flex items-center space-x-4">
            <div class="relative group">
                ...
                <div class="absolute hidden group-hover:block bg-white shadow-lg rounded-md mt-2 right-0 w-48 z-10">
